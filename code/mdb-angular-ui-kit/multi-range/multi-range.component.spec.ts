  ...
  describe('after init', () => {
    ...
    describe('mouse pointer', () => {
      it('should change control value upon ui thumb sliding', () => {
        ...
        expect(component.multiRange.val[0]).toBe(30);
        expect(component.multiRange.val[1]).toBe(60);
        ...
        expect(component.multiRange.val[0]).toBe(30);
        expect(component.multiRange.val[1]).toBe(58);
      });
      ...
      it('should move at a pace multiplied by step input value', () => {
        ...
        expect(component.multiRange.val[0]).toBe(25);
        ...
        expect(component.multiRange.val[0]).toBe(50);
      });
      ...
      it('shouldnt take value over max', () => {
        ...
        expect(component.multiRange.val[1]).toBe(45);
      });
